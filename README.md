...
Assume that you already have AWS account, log in to your EC2 dashboard, click "spot requests", 
, and then "Request Spot Instances". A new configuration page will pop up
...
Next, I will clear thing up by terminating the instance to stop charging
